    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-900">
      <header className="min-h-screen fixed border-b bg-white w-60 bg-gradient-to-br from-blue-900/100 via-purple-900/100 to-pink-900/100">
        <div className="mx-auto max-w-5xl px-4 py-6">
          <div>
            <div className="items-center text-center gap-4 space-x-3">
            ...
            <nav className="mt-10">
              <a href="/dashboard" className="pl-10 bg-gradient-to-br from-blue-800/100 via-purple-800/100 to-pink-800/100 text-lg/10 text-gray-200 hover:bg-gray-900 flex items-center space-x-3 rounded">
              ...
              {workoutTypeBreakdown.length > 0 ? (
                workoutTypeBreakdown.map((workout) => (
                  <div key={workout.type} className="space-y-1">
                    <div className="flex justify-between text-sm">
                      <span className="text-white">{workout.type}</span>
