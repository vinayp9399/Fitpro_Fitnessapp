        ...
        <div className="mx-auto max-w-5xl px-4 py-6">
          <div>
            ...
            <nav className="mt-10">
              ...
              <a href="/meals" className="pl-10 bg-gradient-to-br from-blue-800/100 via-purple-800/100 to-pink-800/100 text-lg/10 text-gray-200 hover:bg-gray-900 flex items-center space-x-3 rounded">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
